...
const testimonials = [
  { id: "t1", name: "Ishita", role: "PR head, DBUU", quote: "The best community I've joined. The feedback culture is incredible—fast iteration, real care.", rating: 5, photo: "/assets/team-mates/ishita.jpg" },
  { id: "t2", name: "Shreya", role: "Tech Head, Frontend Developer", quote: "I shipped my first project because the learning was hands-on and premium. Truly transformative.", rating: 5, photo: "/assets/team-mates/shreya.jpg" },
  { id: "t3", name: "Om Giri", role: "Organizer, Head", quote: "A community that's calm, focused, and creative—exactly what I needed to grow.", rating: 5, photo: "/assets/team-mates/om.png" },
